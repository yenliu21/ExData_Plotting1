...
plot(data$NewDate,data$Global_active_power, xlab="", ylab="Global Active Power", type="n")
...
plot(data$NewDate,data$Voltage, xlab="datetime", ylab="Voltage", type="n")
lines(data$NewDate,data$Voltage)

plot(data$NewDate,data$Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type="n")
lines(data$NewDate,data$Global_reactive_power)
